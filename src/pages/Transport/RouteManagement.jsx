...
const RouteManagement = () => {
  ...
  // =========================================================
  // HELPER - CONVERT BACKEND ROUTE TO FRONTEND FORMAT
  // =========================================================
  ...
  const fetchRoutes = async () => {
    ...
    try {
      ...
      setRoutes(data.map(formatRoute));
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      /*
       * Backend me stops String hai.
       *
       * Example:
       * "Brahampura, Company Bagh, Mithanpura"
       */

      const stopsString = formData.stops
        .split(",")
        .map((stop) => stop.trim())
        .filter(Boolean)
        .join(", ");
      ...
      if (editRoute) {
        const response = await axiosInstance.put(
          `/api/transport/routes/${editRoute.id}?schoolId=${schoolId}`,
          payload,
        );

        const updatedRoute = formatRoute(response.data);
      ...
      // ================= CREATE =================
        ...
        const newRoute = formatRoute(response.data);
  ...
  const openViewModal = async (route) => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `/api/transport/routes/${route.id}?schoolId=${schoolId}`,
      );

      setViewRoute(formatRoute(response.data));
      setShowViewModal(true);
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      await axiosInstance.delete(
        `/api/transport/routes/${id}?schoolId=${schoolId}`,
      );
  ...
  const toggleStatus = async (route) => {
    ...
    try {
      setStatusLoading(route.id);

      const response = await axiosInstance.patch(
        `/api/transport/routes/${route.id}/status?schoolId=${schoolId}`,
        {
          status: newStatus,
        },
      );
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="p-3 rounded-3 bg-light">
                      ...
                      <div className="fw-semibold d-flex align-items-center gap-2">
                        ...
                        <LuMapPin className="text-success" />
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="p-3 rounded-3 bg-light">
                      ...
                      <div className="fw-semibold d-flex align-items-center gap-2">
                        ...
                        <LuMapPinned className="text-danger" />
