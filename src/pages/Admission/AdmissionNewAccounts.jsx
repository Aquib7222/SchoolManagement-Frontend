...
import html2canvas from "html2canvas";
import jsPDF from "jspdf";
import { IoSearchSharp, IoClose, IoPrintOutline } from "react-icons/io5";
import {
  FaRegEye,
  FaShieldAlt,
  FaUserCircle,
              ...
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-muted small">
                    Admission &nbsp;/ &nbsp; Student New Accounts
                  </div>
                </div>
              </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div>
                  <h6 className="mb-1 fw-bold" style={{ color: "#1f2937" }}>
                    Student List
                  </h6>
              ...
              <div className="p-3">
                  ...
                  >
                    ...
                    <tbody>
                      {searchLoading ? (
                        ...
                        currentStudents.map((student, index) => (
                          <tr
                            key={student.id || student.admissionNumber || index}
                          >
                            <td
                              style={{
                                color: "#6b7280",
                            ...
                            <td>
                              <div className="d-flex align-items-center gap-2">
                                {student.photo ? (
                                  ...
                                  <FaUserCircle size={34} color="#cbd5e1" />
                                )}
                            ...
                            >
                              {student.mobile || student.preferredNo || "-"}
                            </td>
                ...
                {students.length > 0 && (
                  ...
                  >
                    ...
                    >
                      Showing <strong>{indexOfFirstStudent + 1}</strong> -{" "}
                      <strong>
                ...
                <div className="p-3">
                  <div className="row align-items-center">
                    ...
                    <div className="col-md-5 ps-md-4 mt-3 mt-md-0">
                      ...
                      <p className="small mb-2">
                        <strong>Password:</strong>{" "}
                        <span className="badge bg-light text-dark">1234</span>
                      </p>
                      ...
                      <p className="small mb-2">
                        <strong>User Group:</strong> STUDENT USER
                      </p>
                      ...
                      <div className="col-5 ps-3">
                        ...
                        <div className="text-center mt-2">
                          {selectedStudent.photo ? (
                            ...
                            <FaUserCircle size={58} color="#cbd5e1" />
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-7">
                        ...
                        <p className="small mb-2">
                          ...
                          >
                            {selectedStudent.firstName}@{selectedStudent.admissionNumber}
                          </span>
                        </p>
