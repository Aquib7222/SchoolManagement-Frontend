...
const MonthlyAttendanceReport = () => {
  ...
  const percentage = ((totalPresent / totalWorkingDays) * 100).toFixed(2);

  console.log(percentage); // 51.85
          ...
          <div className="ms-2 me-2 bg-white rounded shadow mt-3 p-3">
            <div className="row ">
              ...
              <div className="col-12 col-md-4 d-flex ">
                <h6>Class Average Attendance: </h6>
                <strong className="text-danger">{percentage} %</strong>
              </div>
            ...
            <div className="card">
              <div className="card-header">
                ...
                <div className="d-flex gap-5 mt-1">
                  ...
                  <h6>
                    Total Students: <strong>{filterStudents.length}</strong>
                  </h6>
                    ...
                    <tbody>
                      {filterStudents.map((student, index) => (
                        <tr key={student.studentId}>
                          ...
                          >
                            {((student.present / workingDays) * 100).toFixed(2)}{" "}
                            %
                          </td>
