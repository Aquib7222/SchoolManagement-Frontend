...
const MonthlyFeeCollection = () => {
  ...
  const exportExcel = () => {
    ...
    XLSX.writeFile(workbook, "Monthly_Fee_Collection_Report.xlsx");
  };
        ...
        <div className="col-md-8">
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active">Monthly Collection Report</li>
            </ol>
          </nav>
        </div>
      </div>
...
=========================== */}
      ...
      <div className="card shadow mb-3">
        <div className="card-header bg-white">
          <h5 className="mb-0">Monthly Fee Collection Report</h5>
        </div>
        ...
        <div className="card-body">
          <div className="row align-items-center">
            ...
            <div className="col-md-6">
              ...
              <small className="text-muted">Monthly Fee Collection Report</small>
            </div>
