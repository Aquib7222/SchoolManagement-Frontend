...
import { MdOutlineSchool, MdPayments } from "react-icons/md";
...
const MonthlyFeeCollection = () => {
  ...
  const downloadPDF = () => {
    ...
    doc.save(
      "Monthly_Fee_Collection_Report.pdf"
    );
  };
              ...
              <div className="col-xl-3 col-md-6">
                ...
                <div className="input-group">
                  ...
                  <input
                    type="text"
                    className="form-control"
                    placeholder="Admission / Name / Receipt / Fee"
                    value={searchText}
                    onChange={(e) =>
                      setSearchText(
                        e.target.value
                  ...
                  {loading ? (
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <small className="text-muted">
                          No monthly fee collection
                          record matches your selected
                          filters.
                        </small>
