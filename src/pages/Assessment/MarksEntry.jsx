...
const MarksEntry = () => {
  ...
  const marksResponse = async (
    ...
    try {
      ...
      studentList.forEach((student) => {
        ...
        (assessmentStructure?.assessmentTypes || []).forEach(
          (component) => {
            finalMarks[student.id][component.id] =
              saved?.[component.id] ?? 0;
          }
        );

        if (saved) {
          finalMarks[student.id].totalMarks =
            saved.totalMarks ?? 0;

          finalMarks[student.id].percentage =
            saved.percentage ?? 0;

          finalMarks[student.id].grade =
            saved.grade ?? "-";

          finalMarks[student.id].gradePoint =
            saved.gradePoint ?? 0;

          finalMarks[student.id].remark =
            saved.remark ?? "";
        }
      });
      ...
      if (error.response?.status === 404) {
        ...
        studentList.forEach((student) => {
          ...
          (
            assessmentStructure?.assessmentTypes || []
          ).forEach((component) => {
            zeroMarks[student.id][component.id] = 0;
          });
  ...
  const handleLoadStudents = async () => {
    ...
    try {
      ...
      toast.success(
        "Students and saved marks loaded"
      );
    } catch (error) {
      console.error(
        "Load Students Error:",
  ...
  const totalPassingMarks =
    structure?.assessmentTypes?.reduce(
      (sum, item) =>
        sum + Number(item.passingMarks || 0),
      0
    ) || 0;
  ...
  const highestMarks =
    studentTotals.length
      ? Math.max(...studentTotals)
      : 0;

  const lowestMarks =
    studentTotals.length
      ? Math.min(...studentTotals)
      : 0;
        ...
        >
          ...
          <div>
            ...
            <small className="text-muted">
              ...
              exam, class, section and subject
              to load students and enter
              assessment marks.
            </small>
          </div>
        </div>
      ...
      {!structure &&
        !students.length && (
          <div className="mx-2 mb-4">
            <div
              className="rounded-4 text-center p-5"
              style={{
                backgroundColor:
                  "#ffffff",
                border:
                ...
                <div className="row g-3 align-items-stretch">
                  ...
                  <div className="col-6 col-md-3 col-xl-2">
                    <div className="border rounded-4 p-3 h-100">
                      ...
                      <h4 className="mb-0 mt-1 fw-bold text-primary">
                        {totalMaxMarks}
                      </h4>
                    </div>
                  </div>
                  ...
                  <div className="col-6 col-md-3 col-xl-2">
                    <div className="border rounded-4 p-3 h-100">
                      ...
                      <h4 className="mb-0 mt-1 fw-bold text-success">
                        {
                          totalPassingMarks
                        }
                      </h4>
                  ...
                  <div className="col-6 col-md-3 col-xl-2">
                    <div className="border rounded-4 p-3 h-100">
                      ...
                      <h4 className="mb-0 mt-1 fw-bold text-dark">
                        {
                          students.length
                        }
                      </h4>
                        ...
                        (
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="fw-semibold text-muted px-3">
                                {String(
                                  studentIndex +
                                    1
                                ).padStart(
              ...
              <div className="card-footer bg-white border-0 p-3 p-md-4">
                <div className="d-flex flex-wrap justify-content-between align-items-center gap-3">
                  <div className="d-flex flex-wrap gap-2">
                    <button className="btn btn-sm btn-outline-success rounded-3">
                      <LuFileSpreadsheet
                        size={16}
                        className="me-1"
                      />
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    <button
                      className="btn btn-sm btn-outline-dark rounded-3 px-3"
                      onClick={
                        handleSaveDraft
                      }
                      disabled={
              ...
              <div className="col-6 col-md-4 col-xl-2">
                <div className="card border-0 shadow rounded-4 h-100">
                  <div className="card-body p-3">
                    ...
                    <h4 className="fw-bold text-warning mt-2 mb-0">
                      {
                        lowestMarks
                      }
                    </h4>
