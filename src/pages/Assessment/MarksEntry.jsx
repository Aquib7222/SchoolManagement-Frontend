...
//       toast.success("Students and assessment structure loaded");
//     } catch (error) {
...
//     // console.log("Saved Marks Draft Data:", res.data);

//     setSavedMarks(res.data);
...
//     // Agar pehle marks save nahi hain
...
// console.log("Saved Marks Draft Data:",savedMarks);
...
//                         <th key={component.id || index} className="text-center">
//                           Marks Obtained
//                         </th>
//                       ))}
//                     </tr>
...
//                       const maxMarks = totalMaxMarks || 100;
...
//                               <td key={component.id || componentIndex}>
//                                 <input
//                                   type="number"
//                                   className="form-control form-control-sm text-center"
//                                   min="0"
//                                   max={
//                                     component.maxMarks || component.marks || 100
//                                   }
//                                   value={
//                                     marks[component.id || componentIndex] || ""
//                                   }
//                                   onChange={(e) =>
//                                     handleMarksChange(
//                                       student.id,
...
//                             <span
//                               className={`fw-bold ${
//                                 total >= (structure.passingMarks || 33)
//                                   ? "text-success"
//                                   : "text-danger"
//                               }`}
//                             >
...
//                               value={studentMarks[student.id]?.remark || ""}
//                               onChange={(e) =>
//                                 setStudentMarks((prev) => ({
//                                   ...prev,
//                                   [student.id]: {
...
//                   <h5 className="mb-0 text-primary fw-bold">0</h5>
//                 </div>
//               </div>
//             </div>
...
//                   <h5 className="mb-0 text-success fw-bold">0</h5>
//                 </div>
//               </div>
//             </div>
...
//                   <h5 className="mb-0 text-warning fw-bold">0</h5>
//                 </div>
//               </div>
//             </div>
//           </div>
